...
| Default configuration                  | Base/default configuration file                                      | `config.location` <br> or <br> `CONFIG_LOCATION`                                                                | `application.yaml`                                                                                                                                        |
| Additional configuration file location | Location of additional configuration files to be merged with default | `config.additionalLocation` <br> or <br> `config.additional-location` <br> or <br> `CONFIG_ADDITIONAL-LOCATION` | `undefined` <br /> If additional locations are provided, separate file names with `,`. <br> (e.g.) `application-tenant-a.yaml, application-tenant-b.yaml` |
